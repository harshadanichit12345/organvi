...
// Import product images for dry fruits
...
import rainseImg from '../../assets/rainse1.png';
import almondsGifImg from '../../assets/almonds-17904960-unscreen.gif';
import dryfruitsHeroImg from '../../assets/dryfruitshero.jpg';
...
const DryFruits = () => {
  ...
  // Dry Fruits products data - Each product is unique with distinct names and images
  ...
  const openEditModal = (cartItem) => {
    // Find the product from the dry fruits data
    const product = dryFruitsProducts.find(p => p.id === cartItem.id);
        ...
        <div className="dryfruits-content">
          <div className="dryfruits-sidebar">
            {/* <Filter 
              ...
              categories={[{ id: 'dryfruits', name: 'Dry Fruits', products: dryFruitsProducts }]}
              selectedCategory="dryfruits"
            /> */}
          </div>
          ...
          <div className="dryfruits-main">
            <div className="dryfruits-header">
              <h1 className="dryfruits-title">Dry Fruits</h1>
            ...
            <div className="dryfruits-info">
              <div className="dryfruits-info-content">
            ...
            {filteredProductsList.length === 0 && (
              <div className="no-products">
                <p>No dry fruit products found matching your filters.</p>
                <button 
