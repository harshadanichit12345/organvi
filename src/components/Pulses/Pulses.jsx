...
const Pulses = () => {
  ...
  // Pulses products data - Each product is unique with distinct names and images
  ...
  const openEditModal = (cartItem) => {
    // Find the product from the pulses data
    const product = pulsesData.find(p => p.id === cartItem.id);
  ...
  const filteredProductsList = applyFilters(pulsesProducts, filters);
    ...
    <div className="pulses-page">
      <div className="pulses-container">
        <div className="pulses-content">
          <div className="pulses-sidebar">
            {/* <Filter 
              onFilterChange={handleFilterChange}
              categories={[{ id: 'pulses', name: 'Pulses & Dal', products: pulsesProducts }]}
              selectedCategory="pulses"
            /> */}
          </div>
          
          <div className="pulses-main">
            <div className="pulses-header">
              <h1 className="pulses-title">Pulses & Dal</h1>
              <p className="pulses-subtitle">Discover our premium collection of organic pulses and dal</p>
            </div>
            
            <div className="pulses-info">
              <div className="pulses-info-content">
              <p className="pulses-count">
                {filters.selectedItems && filters.selectedItems.length > 0 ? (
                  ...
                  `Showing ${filteredProductsList.length} of ${pulsesProducts.length} products`
                )}
              </p>
            ...
            <div className="pulses-scroll-container">
            ...
            {filteredProductsList.length === 0 && (
              <div className="no-products">
                <p>No pulses products found matching your filters.</p>
                <button 
